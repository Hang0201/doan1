  ...
  return (
    <div className='w-3/4 mx-auto grid grid-cols-3 gap-6 my-[50px]'>
      ...
      <div className='col-span-2'>
        <h2 className='uppercase absolute left-[48%] text-[24px] font-semibold text-red-600'>Tài khoản của tôi</h2>
        ...
        <button className='border-2 border-solid border-red-500 w-[80%] text-[20px] text-red-600 uppercase 

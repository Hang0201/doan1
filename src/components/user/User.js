  ...
  return (
    <div className='w-3/4 mx-auto grid grid-cols-3 gap-6 mt-[50px] h-[37vh]'>
        ...
        <div>
            ...
            <h3 className='text-[30px]'>Chào mừng bạn!</h3>
        </div>
      <div>
        <div className='text-center'>
            <h2 className='font-semibold text-[20px] text-red-600 border-2 border-red-500 rounded-xl w-4/6 py-2 mb-4 mx-auto'>Có thể bạn quan tâm</h2>
            <div>
                <Slider {...settings}>
                    {data.map((value) => {
                        return (
